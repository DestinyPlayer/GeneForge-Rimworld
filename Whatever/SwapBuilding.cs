...
namespace RimWorld
{
    ...
    public class CompSwapBuilding_BMU : ThingComp
    {
        // Token: 0x170015C2 RID: 5570
        // (get) Token: 0x06007DB1 RID: 32177 RVA: 0x002B3405 File Offset: 0x002B1605
        private CompPropertiesSwapBuilding_BMU Props
        {
            get
            {
                return (CompPropertiesSwapBuilding_BMU)this.props;
            }
        }
        ...
        {
            if (ParentIsInactive && this.PowerOn)
            {
